...
CURLOPT_USERAGENT => 'DESCRIPTION by ️ Afzal',
));
$ch=curl_exec($cx);
        curl_close($cx);
        return ($ch);
...
<div class="g-ytsubscribe" data-channelid="❤Afzal Bot❤" data-count="default" data-layout="full" data-theme="dark"></center>
<div id="top-content">
<div id="search-form">
</div></div></div>';
...
<div class="g-ytsubscribe" data-channelid="" data-count="default" data-layout="full" data-theme="dark"></center>
...
<button id="submit" class="btn btn-sm btn-primary"style="border: 1px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;">Get Token From Here</button> </a><br>
<div style="border-top: 1px #ccc solid; margin-top: 10px;"></div></br>
<font color="white" size="5">♨️ Psycho  Bot Team♨
</font>
<br>
<div id="top-content">
<div id="search-form">
...
echo'
<center>
            <h4> <font color="Blue";>--- Powered By ️ Afz AL ---</h4></font></h5></p>
            </ol>
...
<div id="footer">
<font color="purple">
 Bot Users : <font color="Blue">'.count($user).'</font>
<br>
<font color="red">
Script bot &copy; ️ TEAM Psycho* <br>
Powered By :  <a href="https://fb.com/afsaldude"><font color="gold">️ Afzal ™</font></a><br>
</div>';
}
